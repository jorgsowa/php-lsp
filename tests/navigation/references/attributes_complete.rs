...
/// code. This was a confirmed gap against a real ~15K-file codebase: the
/// plain-code instantiation was found, the attribute-nested one silently was
/// not. Regression pin — this currently passes.
#[tokio::test]
